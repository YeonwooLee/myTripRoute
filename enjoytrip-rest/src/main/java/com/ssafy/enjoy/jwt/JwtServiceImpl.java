package com.ssafy.enjoy.jwt;

import com.ssafy.enjoy.exception.UnAuthorizedException;
...
public class JwtServiceImpl implements JwtService {
    ...
    private static final int ACCESS_TOKEN_EXPIRE_MINUTES = 500; // 분단위
...
//		return create(key, data, "refresh-token", 1000 * 30 * ACCESS_TOKEN_EXPIRE_MINUTES);
    ...
    /**
     * key : Claim에 셋팅될 key 값 data : Claim에 셋팅 될 data 값 subject : payload에 sub의 value로 들어갈 subject값 expire : 토큰 유효기간 설정을
     * 위한 값 jwt 토큰의 구성 : header + payload + signature
     */
    @Override
